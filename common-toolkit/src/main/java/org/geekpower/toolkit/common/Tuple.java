package org.geekpower.toolkit.common;

import java.io.Serializable;

/**
 * Use generic to implement Tuple Warning: Tuple only reference source object, so user destory
 * source object would cause Tuple value become NULL.
 * 
 * @author songyz
 * @createTime 2020-04-08 17:55:33
 */
public class Tuple {

    /**
     * It is same with Pair, but first element data type is String and provide friendly function name
     * 
     * @param name
     * @param value
     * @return
